...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		if(method.equals("upfy")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from fy where id='"+id+"'",6);
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">老人姓名：</td>
     <td><select name="lr">
    ...
    <%}} %>
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">入住费用：</td>
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">交费状态：</td>
     <td><select name=zt>
